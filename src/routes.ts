...
router.get("/get-static-file", utilsControllers.getStaticFile);

// RELATIONS
router.post(
  "/update-video-galleries",
  relationsControllers.updateVideoGalleries
);
...
router.get(
  ...
  galleryControllers.deleteMissingGalleries
);
